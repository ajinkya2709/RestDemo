...
import com.restdemo.model.Customer;
...
public class CustomerDAO {
	...
	private static List<Customer> customers;
	{
		...
		customers.add(new Customer(101, "John", "Doe", "djohn@gmail.com",
				"121-232-3435"));
		customers.add(new Customer(201, "Russ", "Smith", "sruss@gmail.com",
				"343-545-2345"));
		customers.add(new Customer(301, "Kate", "Williams",
				"kwilliams@gmail.com", "876-237-2987"));
	}
